...
class Article extends Model
{
    ...
    protected $fillable = ['nom_article','num_article','doc_externe','unité','id_comptable', 'description', 'prix_unitaire','quantite','prix_achat','benefice', 'type_article','prix_promo','benefice_promo', 'promo_id','quantite_alert', 'sousUtilisateur_id','user_id','id_categorie_article'];
